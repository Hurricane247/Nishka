...
contract NishkaCoin is BasicToken,Ownable {

   using SafeMath for uint256;
   
   string public constant name = "Nishka";
   string public constant symbol = "NSK";
   uint256 public constant decimals = 18;
   uint256 public buyPrice = 1 * 10 ** decimals;   // per token the price is 2.2222*10^-4 eth, this price is equivalent in wei
   address public ethStore;
   ...
   */
   //TODO: Change the name of the constructor
    ...
    function changeEthCollectionAddress(address ethCollect) public onlyOwner {
        ethStore = ethCollect;
    }
}
